...
class LabReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab_report" do
    assert_difference("LabReport.count") do
      post lab_reports_url, params: { lab_report: { description: @lab_report.description, grade: @lab_report.grade, title: @lab_report.title, users_id: @lab_report.users_id } }
    end
  ...
  test "should update lab_report" do
    patch lab_report_url(@lab_report), params: { lab_report: { description: @lab_report.description, grade: @lab_report.grade, title: @lab_report.title, users_id: @lab_report.users_id } }
